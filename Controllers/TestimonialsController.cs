...
namespace FitnessGYM.Controllers
{
    public class TestimonialsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("TestimonialId,UserId,TContent,IsApproved,SubmittedAt")] Testimonial testimonial)
        {
            ...
            ViewData["UserId"] = new SelectList(_context.Userrs, "UserId", "UserId", testimonial.UserId);
            return View(testimonial);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(decimal id, [Bind("TestimonialId,UserId,TContent,IsApproved,SubmittedAt")] Testimonial testimonial)
        {
